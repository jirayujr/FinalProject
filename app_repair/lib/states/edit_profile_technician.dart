...
class EditProfileTechnician extends StatefulWidget {
  const EditProfileTechnician({Key? key}) : super(key: key);

  @override
  _EditProfileCustomerState createState() => _EditProfileCustomerState();
}

class _EditProfileCustomerState extends State<EditProfileTechnician> {
  UserModel? userModel;
  String? typeTech;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //     if (typeTech == null) {
        //       print('กรุณาเลือกปรเภทของช่าง');
        //       MyDialog().normalDialog(context, 'ยังไม่ได้เลือกประเภทของช่าง',
        //           'กรุณาเลือกประเภทของช่างที่ต้องการ');
        //     } else {
        //       print('Process Edit data to Database');
          ...
          child: Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                buildTitle('ประเภทของช่าง :'),
                buildRadioTechnician1(constraints),
                buildRadioTechnician2(constraints),
                buildRadioTechnician3(constraints),
  ...
  Future<Null> editValueToMySQL(String pathAvatar) async {
    ...
    String apiEditProfile =
        '${MyConstant.domain}/repairer_app/editProfileTechnicWhereId.php?isAdd=true&id=${userModel!.id}&firstname=${firstnameController.text}&lastname=${lastnameController.text}&address=${addressController.text}&phone=${phoneController.text}&avatar=$pathAvatar&lat=${latLng!.latitude}&lng=${latLng!.longitude}&type_technician=$typeTech';
  ...
  Row buildRadioTechnician1(constraints) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
  ...
  Row buildRadioTechnician2(constraints) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
  ...
  Row buildRadioTechnician3(constraints) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
