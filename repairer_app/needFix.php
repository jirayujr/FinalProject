...
// input to php
 ...
 // Decoding the received JSON and store into $obj variable.
    ...
    $orderFixText = $obj['orderFix'];
    $idJobText = $obj['idJob'];
    $dateMeetText = $obj['dateMeet'];
    $timeMeetText = $obj['timeMeet'];
    ...
    $sql = "INSERT INTO give_fix2 (id,date1, time1, typeRepairer,identifySymptoms,address1,image,lat,lng,order_fix,id_job,dateMeet,timeMeet)
    VALUES ('$idText','$dateText','$timeText','$typeRepairerText','$identifySymptomsText','$addressText','[$image1Text,$image2Text,$image3Text,$image4Text]','$latText','$lngText','$orderFixText','$idJobText','$dateMeetText','$timeMeetText')";
